...
const DocumentosQualidade = () => {
  const navigate = useNavigate();
  const fileInputRef = useRef<HTMLInputElement>(null);

  const [folders, setFolders] = useState<Folder[]>([
    { id: '1', name: 'Manual de boas práticas', docs: [] },
    { id: '2', name: 'POPs', docs: [] },
    { id: '3', name: 'Relatório de auditorias', docs: [] },
    { id: '4', name: 'Relatório de rancho', docs: [] },
    { id: '5', name: 'Leitura de termógrafos', docs: [] },
    { id: '6', name: 'Listas', docs: [] },
    { id: '7', name: 'Treinamentos', docs: [] },
  ]);
  ...
  return (
    <div className="min-h-screen bg-card">
      <header className="bg-primary px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-primary-foreground font-bold text-base">Documentos de Qualidade</h1>
      </header>

      <main className="max-w-2xl mx-auto px-4 py-6 animate-fade-in">
        {!openFolderId ? (
          <>
            <p className="text-sm text-muted-foreground mb-5">Gerencie seus documentos de qualidade por pasta.</p>
...
export default DocumentosQualidade;
