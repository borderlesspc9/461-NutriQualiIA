    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-[1100px] mx-auto px-2 py-4 animate-fade-in">
        ...
        <div className="flex gap-3 mt-4 pb-6">
          <button onClick={handleIdentifyNCs}
            className="flex-1 bg-destructive text-destructive-foreground py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2">
